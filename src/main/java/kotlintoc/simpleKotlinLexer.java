...
public class simpleKotlinLexer extends Lexer {
	...
	private static String[] makeRuleNames() {
		return new String[] {
			"NEWLINE", "WHITESPACE", "COMMENT", "BLOCKCOMMENT", "INT", "FLOAT", "SSTRING", 
			"SEMICON", "DOT", "COLON", "COMA", "TRUE", "FUN", "FALSE", "IMP", "FOR", 
			"WHILE", "IF", "ELSE", "TYPE", "VAR", "RETURN", "PACKAGE", "IN", "NAME", 
			"ANNOTATION", "ARASS", "ASSIGN", "ARITHMOP", "MINUS", "LOGICOP", "COMPOP", 
			"INCRDECR", "ORBRACKET", "CRBRACKET", "OBRACE", "CBRACE"
		};
	}
	...
	public simpleKotlinLexer(CharStream input) {
		super(input);
